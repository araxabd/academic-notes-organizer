...
class NoteAuthTest(TestCase):
    ...
    def test_note_list_by_anonymous(self):
    ...
    def test_note_detail_by_anonymous(self):
    ...
    def test_note_create_by_anonymous(self):
    ...
    def test_note_update_by_anonymous(self):
    ...
    def test_note_delete_by_anonymous(self):
