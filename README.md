...
The main purpose of the project is the local organization of notes and courses you have, but there are some marketplace features that let you to see other public courses with the metadata of their public notes, rate, comment and perhaps purchase them in the future.
...
The dockerized project has a volume for database data but staticfiles and media is not in professional production mode. So you have to ensure that you are changing the project and docker settings before using it for serious purposes. But it's totally okay if just want to check it out.
